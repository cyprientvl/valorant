 ...
 */
final class Version20241202150135 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE locker_user (locker_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_703A75A5841CF1E0 (locker_id), INDEX IDX_703A75A5A76ED395 (user_id), PRIMARY KEY(locker_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE locker_user_likes (locker_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_70763D96841CF1E0 (locker_id), INDEX IDX_70763D96A76ED395 (user_id), PRIMARY KEY(locker_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
